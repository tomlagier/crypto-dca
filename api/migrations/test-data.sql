...
CREATE TABLE IF NOT EXISTS "Users" ("id"   SERIAL , "name" VARCHAR(255) NOT NULL, "password" VARCHAR(255) NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL, "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL, PRIMARY KEY ("id"));
...
CREATE TABLE IF NOT EXISTS "Wallets" ("id"   SERIAL , "name" VARCHAR(255) NOT NULL, "address" VARCHAR(255) NOT NULL, "local" BOOLEAN NOT NULL, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL, "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL, "UserId" INTEGER REFERENCES "Users" ("id") ON DELETE SET NULL ON UPDATE CASCADE, PRIMARY KEY ("id"));
SELECT i.relname AS name, ix.indisprimary AS primary, ix.indisunique AS unique, ix.indkey AS indkey, array_agg(a.attnum) as column_indexes, array_agg(a.attname) AS column_names, pg_get_indexdef(ix.indexrelid) AS definition FROM pg_class t, pg_class i, pg_index ix, pg_attribute a WHERE t.oid = ix.indrelid AND i.oid = ix.indexrelid AND a.attrelid = t.oid AND t.relkind = 'r' and t.relname = 'Wallets' GROUP BY i.relname, ix.indexrelid, ix.indisprimary, ix.indisunique, ix.indkey ORDER BY i.relname;
DROP TABLE IF EXISTS "Coins" CASCADE;
CREATE TABLE IF NOT EXISTS "Coins" ("id"   SERIAL , "feeTolerance" VARCHAR(255) DEFAULT '0', "name" VARCHAR(255) NOT NULL, "code" VARCHAR(255) NOT NULL, "active" BOOLEAN DEFAULT false, "portfolioWeight" INTEGER DEFAULT 0, "localAmount" VARCHAR(255) DEFAULT '0', "exchangeAmount" VARCHAR(255) DEFAULT '0', "purchaseAmount" VARCHAR(255) DEFAULT '0', "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL, "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL, "UserId" INTEGER REFERENCES "Users" ("id") ON DELETE SET NULL ON UPDATE CASCADE, "localWalletId" INTEGER REFERENCES "Wallets" ("id") ON DELETE SET NULL ON UPDATE CASCADE, "exchangeWalletId" INTEGER REFERENCES "Wallets" ("id") ON DELETE SET NULL ON UPDATE CASCADE, PRIMARY KEY ("id"));
SELECT i.relname AS name, ix.indisprimary AS primary, ix.indisunique AS unique, ix.indkey AS indkey, array_agg(a.attnum) as column_indexes, array_agg(a.attname) AS column_names, pg_get_indexdef(ix.indexrelid) AS definition FROM pg_class t, pg_class i, pg_index ix, pg_attribute a WHERE t.oid = ix.indrelid AND i.oid = ix.indexrelid AND a.attrelid = t.oid AND t.relkind = 'r' and t.relname = 'Coins' GROUP BY i.relname, ix.indexrelid, ix.indisprimary, ix.indisunique, ix.indkey ORDER BY i.relname;
DROP TABLE IF EXISTS "Transactions" CASCADE;
CREATE TABLE IF NOT EXISTS "Transactions" ("id"   SERIAL , "startAmount" VARCHAR(255) DEFAULT '0', "endAmount" VARCHAR(255) DEFAULT '0', "success" BOOLEAN DEFAULT false, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL, "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL, "UserId" INTEGER REFERENCES "Users" ("id") ON DELETE SET NULL ON UPDATE CASCADE, "startWalletId" INTEGER REFERENCES "Wallets" ("id") ON DELETE SET NULL ON UPDATE CASCADE, "endWalletId" INTEGER REFERENCES "Wallets" ("id") ON DELETE SET NULL ON UPDATE CASCADE, "startCoinId" INTEGER REFERENCES "Coins" ("id") ON DELETE SET NULL ON UPDATE CASCADE, "endCoinId" INTEGER REFERENCES "Coins" ("id") ON DELETE SET NULL ON UPDATE CASCADE, PRIMARY KEY ("id"));
...
SELECT pg_catalog.setval('"Coins_id_seq"', 1, false);
SELECT pg_catalog.setval('"Options_id_seq"', 5, true);
